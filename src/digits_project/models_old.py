...
MODEL_SPECS: tuple[ModelSpec, ...] = (
    ...
    ModelSpec(
        ...
        param_grid={"classifier__estimator__C": [0.1, 1.0, 5.0, 10.0]},
        preprocessors=("raw", "minmax", "zscore", "pca_50", "pca_100", "pca_150"),
    ),
    ModelSpec(
        name="linear_svm_ova",
        estimator_builder=_build_linear_svm,
        param_grid={"classifier__estimator__C": [0.01, 0.1, 1.0, 5.0, 10.0]},
    ...
    ModelSpec(
        ...
        param_grid={
            "classifier__estimator__C": [1.0, 5.0, 10.0],
            "classifier__estimator__gamma": ["scale", 0.001, 0.01],
        },
        preprocessors=("raw", "zscore", "pca_50", "pca_100", "pca_150"),
    ),
    ModelSpec(
    ...
    ModelSpec(
        ...
        param_grid={
            "classifier__hidden_layer_sizes": [(128,), (256,)],
